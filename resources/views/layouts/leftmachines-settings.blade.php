        ...
        <div data-role="container">
            <div data-role="content">
                ...
                <section class="page-aside-section">
                    <h5 class="page-aside-title">Machines </h5>
                    <div class="list-group">
                        ...
                        <a class="list-group-item {{ Route::current()->getName() == 'machines.create' ? 'list-group-item-action active' : '' }}" href="{{ url('machine-management/create') }}">
                            <i class="icon wb-folder" aria-hidden="true"></i>New Machines
                        </a>
