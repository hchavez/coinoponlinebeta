                      ...
                      <div class="example table-responsive">
                        <table class="table table-bordered">
                          <thead><tr><th></th><th>Coin</th><th>Bill</th><th>Card</th><th>Total</th></tr></thead>
                             <tbody>
                            <tr><td>Today</td><td>
                                        <?php echo round($coin['today'],2);  ?></td><td>
                                        {{ $bill['today'] }}</td><td> 
                                        <?php echo round($card['today'], 2); ?></td><td>
                                         <?php echo round($coin['today'] + $bill['today'] + $card['today'], 2); ?></td></tr>
                            
                            <tr><td>Yesterday</td><td>
                                <?php echo round( $coin['yesterday'],2);  ?></td><td>
                                {{ $bill['yesterday'] }}</td><td>
                                <?php echo round($card['yesterday'], 2); ?></td><td>
                                <?php echo round($coin['yesterday'] + $bill['yesterday'] + $card['yesterday'], 2); ?></td></tr>
                            
                            <tr><td>This week</td><td>
                               <?php echo round( $coin['thisWeek'],2);  ?></td><td>
                               {{ $bill['thisWeek'] }}</td><td>
                               <?php echo round($card['thisWeek'], 2); ?></td><td>
                               <?php echo round($coin['thisWeek'] + $bill['thisWeek'] + $card['thisWeek'], 2); ?></td></tr>
                            <tr><td>This Month</td><td>
                                <?php echo round( $coin['thisMonth'],2);  ?></td><td>
                                {{ $bill['thisMonth'] }}</td><td>
                                <?php echo round($card['thisMonth'], 2); ?></td><td>
                                <?php echo round($coin['thisMonth'] + $bill['thisMonth'] + $card['thisMonth'], 2); ?></td></tr>
                            <tr><td>This Financial Year</td><td>
                                <?php echo round( $coin['thisFinancial'],2);  ?></td><td>
                                {{ $bill['thisFinancial'] }}</td><td>
                                <?php echo round($card['thisFinancial'] , 2); ?></td><td>
                                <?php echo round($coin['thisFinancial'] + $bill['thisFinancial'] + $card['thisFinancial'], 2); ?></td></tr>
                            <tr><td>This Calendar Year</td><td>
                                <?php echo round( $coin['thisYear'],2);  ?></td><td>
                                {{ $bill['thisYear'] }}</td><td>
                                <?php echo round($card['thisYear'], 2); ?></td><td>
                                 <?php echo round($coin['thisYear'] + $bill['thisYear'] + $card['thisYear'], 2); ?></td></tr>                        
                          </tbody>
                        </table>
