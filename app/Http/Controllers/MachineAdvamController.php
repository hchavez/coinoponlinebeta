...
class MachineAdvamController extends Controller {
...
//         
//        return view('machine-advam', ['start' => Input::get('startdate'),'end' => Input::get('enddate'), 'machines' => $machines]);
               return view('machine-advam/index');
